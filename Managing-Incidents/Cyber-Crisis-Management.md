...
Cyber Crisis Management is the strategic coordination of response during major cybersecurity incidents that impact business operations. However, based on the severity of the incident, the blue team decides the best response. In our example, only a level 4 incident would trigger the Crisis Management Team (CMT). As a refresher, these were the four levels:
...
4. Public relations handling
5. Business continuity planning

---

## Difference Between Incident Response and Crisis Management

Incident Response = Technical handling  
Crisis Management = Organizational & strategic handling
